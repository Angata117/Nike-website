  ...
  return (
    <section id="products"
      ...
      <div className="flex flex-col justify-start gap-5 ">
        ...
        <p className="lg:max-w-lg mt-2 font-montserrat text-slate-gray">Experience top-notch quality and style with ourr sought-after selections. Discover a world of comfort
          design, and value
        </p>
      </div>
