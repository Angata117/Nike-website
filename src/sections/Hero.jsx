  ...
  return (
    <section id="home"
      ...
      <div className="relative xl-w-2/5 flex flex-col justify-center 
        ...
        <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm">Discover stilysh nike arivals, quality comfort, and innovation for your active life.</p>
